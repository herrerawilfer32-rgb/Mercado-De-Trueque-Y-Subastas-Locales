	...
	public Oferta realizarNuevaOferta(String idOferta, String idPublicacion, String idOfertante, Date fechaOferta, double montoOferta, String descripcionTrueque) {
		...
		if (publicacion.getTipoPublicacion() == TipoPublicacion.SUBASTA) {
			...
			if (montoOferta <= mayorOferta) {
				throw new RuntimeException("Error: El monto de la oferta debe ser superior a la mayor oferta actual de " + mayorOferta);
			}
		}
		...
		Oferta nuevaOferta = new Oferta(idOferta, idPublicacion, idOfertante, new java.util.Date(), montoOferta, descripcionTrueque, EstadoOferta.PENDIENTE);
